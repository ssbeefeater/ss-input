...
(function(e){Ss_input.fileSystem.download=Ss_input.Plugin.extend({init:function(){this.setButtons()},setButtons:function(){var b=this;this.ssi.addButton({label:'<div class="icon ssi-download">'+this.translate("download")+"</div>",method:function(){b.openInBrowser()},className:"ssi-openInBtn",selectionRequired:!0},"listButton",["contextMenu"],'condition:(field:(mimeType)!="directory")')},openInBrowser:function(){var b=this.ssi,a=b.getSelectedField("name")[0];window.open(b.fileSystem.getPath(a),"_blank")}})})(jQuery);
