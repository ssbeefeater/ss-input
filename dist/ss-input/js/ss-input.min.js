(function(e,a){function b(b){var c;e(window).bind("beforeunload",function(){b.$element.trigger("resetAction.ssi").trigger("closeAction.ssi").off(".ssi")});b.$content.on({"mouseenter.ssi":function(b){b.preventDefault();c=e(this).find(".ssi-optionsDiv");c.fadeIn(200)},"mouseleave.ssi":function(){!1===c.hasClass("selected")&&c.fadeOut(200)}},".ssi-displayDiv");b.$element.on("closeAction.ssi",function(){a.removeAll();b.currentCollection={};b.initializedButtons=[];b.readOnlyMode="";e(this).off(".ssi");
e("body").off(".ssi")});b.$content.on("click",function(b){e(b.target).is("input")||e(this).focus()})}function c(a){var c=Ss_input.tools.keyExists(a.requireAfter,Ss_input.plugins),d=Ss_input.tools.arrayValuesInArray(a.requireAfter,a.pluginNames);a.pluginNames=a.pluginNames.concat(d);if(0!=c.length)return console.log("Some requirements are missing: "+c.toString()),!1;a.$content=e(Ss_input.templates.mainContent);"modalWindow"!==a.options.showTo&&a.$content.append(Ss_input.templates.bottomButtons);e.isEmptyObject(a.plugins)?
a.pluginInit(a.pluginNames):a.resetPlugins(a.plugins);a.$element.trigger("showAction");c=a.buttonSelectors;a.$content.find(c.menu).append(f[c.menu]);delete f[c.menu];for(var k in f)try{var g=k.split(","),h;if(0!=(h=Ss_input.tools.keyExists(g,a.initializedButtons)).length)for(var c=0,r=h.length;c<r;c++)switch(a.initializedButtons[h[c]]=!0,d=a,Ss_input.tools.findKey(h[c],d.buttonSelectors)){case "actions":d.$content.find(d.buttonSelectors.menu).append(d.addButton({id:"ssi-actionsBtn",title:d.language.actions,
label:'<div class="icon ssi-actionsIcon"></div>',dropDown:!0,selectionRequired:!0},"menuButton",!1));break;case "options":d.$content.find(d.buttonSelectors.menu).append(d.addButton({id:"ssi-TasksBtn",title:d.language.options,label:'<div class="icon ssi-optionsIcon"></div>',dropDown:!0},"menuButton",!1));break;case "openWith":d.$content.find(d.buttonSelectors.contextMenu).append(d.addButton({id:"ssi-openWithBtn",title:d.language.openWith,label:'<span class="icon ssi-openWithIcon"></span>'+d.language.openWith,
selectionRequired:!0,subMenu:!0},"listButton",!1));break;case "editWith":d.$content.find(d.buttonSelectors.contextMenu).append(d.addButton({id:"ssi-editWithBtn",title:"editWith",label:'<span class="icon ssi-editWithIcon"></span>editWith',subMenu:!0,selectionRequired:!0},"listButton",!1))}a.$content.find(k).append(f[k])}catch(A){}f={};b(a);return a.$content}function d(b,a){b=b||(a.$content.hasClass("ssi-multiPickMode")&&"modalWindow"!=a.options.showTo?115:70);var c=parseInt(a.$content.parent().height())-
b;a.$content.find("#ssi-mainContent").css("height",c)}var f={},g=0;this.Ss_input=function(b,a){this.ssi_excludeList={};this.options=e.extend(!0,{plugins:[],modalOptions:{sizeClass:"large",fixedHeight:!0,fitScreen:!0,buttons:[]},permissions:["all"],excludePlugin:[],language:"en",mode:"selection",storageType:"fileSystem",showTo:"modalWindow",responseValidation:!1},a);this.requireAfter=["scan"];this.uniqueId=g;this.readOnlyMode=!1;this.plugins=[];this.pluginNames=[];this.handlersGroup="handlers";this.corePlugins=
[];this.initializedButtons={};this.readyState=!1;this.language=Ss_input.locale[this.options.language];this.$element=e(b);g++;this.init()};Ss_input.prototype.buttonSelectors={menu:"#ssi-menuButtons",contextMenu:"#ssi-contextMenuUl",options:"#ssi-TasksBtn+ul",actions:"#ssi-actionsBtn+ul",items:".ssi-optionsDiv",bottom:"#ssi-rightButtons",openWith:"#ssi-openWithBtn ul",editWith:"#ssi-editWithBtn ul"};Ss_input.prototype.init=function(){var b=Ss_input.tools.keyExists(this.options.storageType,Ss_input.storageTypes),
b=b.concat("manager"!=this.options.mode?Ss_input.tools.keyExists(this.options.mode,Ss_input.modePlugins):[],Ss_input.tools.keyExists(this.require,Ss_input.plugins));if(0!=b.length)console.log("Some requirements are missing: "+b.toString());else{if(0<this.options.plugins.length){if(this.pluginNames=this.options.plugins,b=Ss_input.tools.arrayValuesInArray(this.require,this.pluginNames))this.pluginNames=this.pluginNames.concat(b)}else for(var a in Ss_input.plugins)this.pluginNames.push(a);this.pluginInit(this.options.storageType,
Ss_input.storageTypes);this[this.options.storageType]=this.corePlugins[this.options.storageType];"manager"!=this.options.mode?(this.pluginInit(this.options.mode,Ss_input.modePlugins),this[this.options.mode]=this.corePlugins[this.options.mode]):("modalWindow"!=this.options.showTo&&(this.options.showTo=this.$element),this.$element.addClass("ss-input"));if("modalWindow"===this.options.showTo)h(this);else if(b=e(this.options.showTo),b.is("div")){if(this.$element.trigger("earlyShowAction"),a=c(this))b.first().addClass("ssi-mainModal").html(a),
d(null,this)}else console.log("Use a div.")}};var h=function(b){e.extend(b.options.modalOptions,{className:"ssi-mainModal",onClose:function(){b.$element.trigger("resetAction.ssi").trigger("closeAction.ssi")}});b.$element.on("click",function(a){a.preventDefault();b.$element.trigger("earlyShowAction");if(e(a.target).hasClass("ss-input")){a=b.createWindow(b.options.modalOptions);var f=c(b);f?(a.setContent(f),d(null,b)):a.close()}})};Ss_input.prototype.destroy=function(){this.$element.trigger("closeAction.ssi");
this.$content.remove()};Ss_input.prototype.checkPermissions=function(b,a){return("read"===b||"all"===this.options.permissions[0]||0===Ss_input.tools.arrayValuesInArray(b,this.options.permissions).length||-1!==e.inArray(a,this.options.permissions))&&(-1===e.inArray(a,this.options.excludePlugin)||-1!==e.inArray(a,this.require)||-1!==e.inArray(a,this.requireAfter))};Ss_input.prototype.pluginInit=function(b,a){b=Ss_input.tools.toArray(b);for(var c=0,d=b.length;c<d;c++)try{a=a||Ss_input.plugins;if(0!=
Ss_input.tools.keyExists(b[c],a).length)throw"did not load";if(b[c]){var f=new a[b[c]](this,this.options[b[c]]);if(this.checkPermissions(f.permissions,b[c])&&!e.isEmptyObject(f)&&0!==Ss_input.tools.keyExists(b[c],this[f.type]).length){var g=Ss_input.tools.keyExists(f.require,a);if(0===g.length){var k=Ss_input.tools.keyExists(f.require,this[f.type]);this.pluginInit(k);if(0===Ss_input.tools.keyExists(k,this.plugins).length||0===Ss_input.tools.keyExists(k,this.corePlugins).length){this[f.type][b[c]]=
f;if(Ss_input[this.handlersGroup].hasOwnProperty(b[c])){var h=b[c];new Ss_input[this.handlersGroup][h](this,f,h)}else if(Ss_input.handlers.hasOwnProperty(b[c])){var l=b[c];new Ss_input.handlers[l](this,f,l)}f.init()}else throw"requires "+k.toString()+".";}else throw"requires "+g.toString()+".";}}}catch(v){console.log(b[c]+" "+v)}};Ss_input.prototype.resetPlugins=function(b){for(var a in b){var c=b[a];Ss_input[this.handlersGroup].hasOwnProperty(a)?new Ss_input[this.handlersGroup][a](this,c,a):Ss_input.handlers.hasOwnProperty(a)&&
new Ss_input.handlers[a](this,c,a);c.init()}};Ss_input.prototype.addButton=function(b,a,c,d){var g={menuButton:["menu","bottom"],listButton:["options","actions","contextMenu","openWith","editWith"],itemButton:[]};a=a||"menuButton";if("bottom"==c&&"modalWindow"===this.options.showTo)this.options.modalOptions.buttons.push(b);else{var k=new Ss_input.Button(b,a,this.$content);if(c)if(c instanceof e)c.append(k);else if("itemButton"!=a){for(var h=[],l=0,m=c.length;l<m;l++)-1!==e.inArray(c[l],g[a])&&h.push(this.buttonSelectors[c[l]]);
f.hasOwnProperty(h.toString())?f[h.toString()].push(k):f[h.toString()]=[k];d&&b.selectionRequired&&(this.ssi_excludeList[b.className]=d)}return k}};Ss_input.prototype.notify=function(b,c){a.notify(b,{overrideOther:!0,content:c})};Ss_input.prototype.checkExcludedButtons=function(b){var a=this.ssi_excludeList,c=this.get$selectedItems(),d=this.$content.find(".ssi-mustSelect").removeClass("ssi-hidden disabled"),f;for(f in a)c.each(function(){e(this).data("info");if("false"==eval(Ss_input.tools.dataReplace(a[f],
"info"))){var c=d.filter("."+f).addClass("ssi-hidden");"function"===typeof b&&b(c);return!1}})};Ss_input.prototype.createWindow=function(b,c){return a.show(b,c)};Ss_input.prototype.get$mainElementById=function(b,a){a=a||this.$content;return a.find(".ssi-mainElement[data-ID='"+b+"']")};Ss_input.prototype.get$mainElement=function(b){return b.hasClass("ssi-mainElement")?b:b.parents(".ssi-itemWrapper").find(".ssi-mainElement")};Ss_input.prototype.getId=function(b){if(b)return"string"===typeof b?this.get$mainElementById(b).attr("data-ID"):
this.get$mainElement(b).attr("data-ID");var a=[];this.get$selectedItems().each(function(){a.push(e(this).attr("data-ID"))});return a};Ss_input.prototype.get$itemWrapper=function(b){return b.parents(".ssi-itemWrapper")};Ss_input.prototype.get$selectedItems=function(b){try{var a=this.plugins.select;return b?this.get$mainElement(b):0<a.selectionList.length?e(".ssi-mActive"):this.plugins.contextMenu.rightClickItem||e()}catch(m){return e()}};Ss_input.prototype.getSelectedData=function(b){try{var a=[];
this.get$selectedItems(b).each(function(){a.push(e(this).data("info"))});return a}catch(m){return[]}};Ss_input.prototype.getSelectedField=function(b,a){for(var c=this.getSelectedData(a),d=[],f=0,e=c.length;f<e;f++)try{d.push(c[f][b])}catch(r){}return d};Ss_input.prototype.getPageData=function(b){var a=this.plugins.cache,c=[];if(a)c=a.getCachedPage(b).data;else{if(b&&b!=this.currentCollection.id)return[];this.$content.find(".ssi-selectable").each(function(){c.push(e(this).data("info"))})}return c||
...
a){return b.replace(/field:\((\w+)\)/g,(a||"data")+'["$1"]')},arrayValuesInArray:function(b,a){b=this.toArray(b);for(var c=[],f=0,g=b.length;f<g;f++)b[f]&&-1===e.inArray(b[f],a)&&c.push(b[f]);return c},keyExists:function(b,a){b=this.toArray(b);for(var c=[],f=0,e=b.length;f<e;f++)b[f]&&!a.hasOwnProperty(b[f])&&c.push(b[f]);return c},getDate:function(){var b=new Date,a=b.getMonth()+1,d=b.getDate();return b.getFullYear()+"-"+(2>(""+a).length?"0":"")+a+"-"+(2>(""+d).length?"0":"")+d},urlUnion:function(b,
a){var c=b.length-1;"/"!=b[c]&&"/"!=a[0]?b+="/":"/"===b[c]&&"/"===a[0]&&(a=a.substr(1));return b+a},cachedImage:function(b){var a=document.createElement("img");a.src=b;return a.complete||0<a.width+a.height},cutFileName:function(b,a,d){"undefined"===typeof a&&(a="");"undefined"===typeof d&&(d=10);if(!(4>d)){var c=a.length;return b.length-2>d?(b=b.substring(0,d),b=b.substring(0,b.length-c),b+"..."+a):b}},toArray:function(b){b instanceof Array||(b=[b]);return b},findKey:function(b,a){for(var c in a)try{if(a[c]===
b)return c}catch(f){}},findByKey:function(b,a,d){for(var c=0,e=b.length;c<e;c++)if(b[c][a]==d)return b[c];return!1},removeMirrorValues:function(b){var a;do{a=!1;for(var d=0;d<b.length;d++)b[d]===b[d+1]&&(b.splice(d,1),a=!0)}while(1==a)},arraySum:function(b){for(var a=0,d=0;d<b.length;d++)a+=b[d];return a},loadImage:function(b,a,d){b=b||e();if(a&&"undefined"!=a)if(Ss_input.tools.cachedImage(a))b.css("background-image",'url("'+a+'")');else{var c=e('<div class="ssi-loadingIcon ssi-itemLoader"></div>');
b.append(c);e("<img/>").attr("src",a).load(function(){e(this).remove();c.remove();"function"===typeof d?d(!0):b.css("background-image",'url("'+a+'")')}).error(function(){e(this).remove();c.remove();"function"===typeof d?d(!1):b.css("background-image",'url("'+a+'")');b.parents(".ssi-itemWrapper").addClass("ssi-empty")})}else b.parents(".ssi-itemWrapper").addClass("ssi-empty")},escape:function(b){return b.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,"\\$&")},escapeHtml:function(b){return String(b).replace(/[&<>"'\/]/g,
function(b){return a[b]})},removeObjFromArray:function(b,a,d){for(var c=0;c<b.length;c++)if(b[c][a]===d){b.splice(c,1);break}},getFirstKey:function(b){for(var a in b)return a},sanitizeInput:function(b){b=b.replace(/[^a-z0-9\u00e1\u00e9\u00ed\u00f3\u00fa\u00f1\u00fc \.,_-]/gim,"");return b.trim()},removeFromArray:function(b,a){a=this.toArray(a);for(var c=0,f=a.length;c<f;c++)for(var e=0,h=b.length;e<h;e++)b[e]===a[c]&&b.splice(e,1)},removeByKey:function(b,a){a=this.toArray(a);for(var c=0;c<a.length;c++)delete b[a[c]]},
tooltip:function(b,a,d){b=e(b);(a=a||b.data("title"))||(a=b.attr("title"));if(a){var c=e('<div class="ssi-fadeOut ssi-fade ssi-tooltipText">'+a+"</div>").insertBefore(b);b.one("mouseleave",function(){c.remove()});if(d)return c;c.css({top:b.position().top-c.height()-12,left:b.position().left}).removeClass("ssi-fadeOut");return c}},isFile:function(b,a){return a?-1<a.indexOf(b.split("/").pop().split(".").pop()):1<b.split("/").pop().split(".").length},replaceText:function(b){for(var a=Array.apply(null,
arguments),d=1;d<a.length;d++)b=b.replace("$"+d,a[d]);return b}};e("body").on("mouseenter",".ssi-tooltip",function(b){Ss_input.tools.tooltip(b.currentTarget)}).on("mouseover","div.ssi-dropDownWrapper .parent",function(b){e(b.currentTarget).children("ul").addClass("ssi-show");e(b.currentTarget).closest("ul").css("overflow","visible")}).on("mouseout","div.ssi-dropDownWrapper .parent,.ssi-dropOptions li>a",function(b){e(b.currentTarget).children("ul").removeClass("ssi-show");e(b.currentTarget).closest("ul").css("overflow",
"")})})(jQuery);
(function(e){Ss_input.selectionMode=[];Ss_input.selection=[];Ss_input.modePlugins.selection=Ss_input.Plugin.extend({type:"corePlugins",defaults:{selectionMode:"singleSelection",excludeItems:"",defaultValue:"",inputName:"",template:"",selectionField:"",modeOptions:{}},init:function(){this.selectionMode=new Ss_input.selectionMode[this.options.selectionMode](this.ssi,this.setModeOptions());this.selectionMode.selection=this;this.pluginNames=[];for(var a in Ss_input.selection)this.pluginNames.push(a);this.selectionMode.init();
this.setEvents().setHandlers()},setEvents:function(){var a=this.ssi,b=this;a.$element.on("showAction",function(){a.pluginInit(b.pluginNames,Ss_input.selection);a.$content.on("click.ssi",".ssi-canSelect",function(c){c.preventDefault();if(!c.ctrlKey){var d=e(c.target);d.is("a")||d.parent().is("a")||b.selectItem("",a.get$mainElement(e(c.currentTarget)))}});b.ssi.$element.on("appendItemAction.ssi",function(a,d){b.options.excludeItems&&"false"!=eval(Ss_input.tools.dataReplace(b.options.excludeItems,"item.data"))||
d.$element.find(".ssi-selectable").addClass("ssi-canSelect")}).on("infoShowAction.ssi",function(c,d){d.find(".ssi-selectable").click(function(c){b.selectItem("",a.get$mainElement(e(c.currentTarget)))})})});return this},setModeOptions:function(){var a={};this.options.defaultValue&&(a.defaultValue=this.options.defaultValue);this.options.selectionField&&(a.selectionField=this.options.selectionField);this.options.inputName&&(a.inputName=this.options.inputName);this.options.template&&(a.template=this.options.template);
return e.extend({},this.options.modeOptions,a)},setHandlers:function(){this.infoHandler();return this},selectItem:function(a,b,c){this.selectionMode.pickData(a,b,c);return this},infoHandler:function(){Ss_input.handlers.info=Ss_input.Handler.extend({template:{imagePreview:'<div class="ssi-imagePreview"></div>'},defaults:{excludeItems:'condition:(field:(mimeType)=="directory")'},extend:{handleData:function(a){for(var b=0,c=a.length;b<c;b++){var d=this.ssi.plugins.templateManager.getTemplate(a[b]," ",
...
buttons:[{label:'<div class="icon ssi-checkIcon"></div>',className:"ssi-inBtn ssi-inUrlBtn",method:function(){a.addUrl()}}]},className:"ssi-urlSwitch"},"menuButton",["menu"])},addUrl:function(){var a=this.ssi,c=a.$content.find("#ssi-url").val();if(""!=c){var d=this;this.testUrl(c)&&this.IsValidImageUrl(c,function(){console.log();"multiSelection"===a.corePlugins.selection.options.selectionMode&&a.notify("success",d.translate("addSuccess"));a.corePlugins.selection.selectItem(c,"",!0)})}},testUrl:function(b){var c=
...
c){var b=this,f=this.ssi;e("<img>",{src:a,error:function(){f.notify("error",b.translate("invalidUrlError"))},load:function(){c()}})}});a.regex=/^\s*data:([a-z]+\/[a-z0-9\-\+]+(;[a-z\-]+\=[a-z0-9\-]+)?)?(;base64)?,[a-z0-9\!\$\&\'\,\(\)\*\+\,\;\=\-\.\_\~\:\@\/\?\%\s]*\s*$/i})(jQuery);
