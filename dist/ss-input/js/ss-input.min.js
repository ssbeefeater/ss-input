...
e){d.save(b[d.database.currentCollection.id],function(b,c,f,g){200==f.status&&(e&&e.close(),a.plugins.scan.resetItem(b[d.database.currentCollection.id],"object"===typeof b&&b.hasOwnProperty(d.database.currentCollection.id)?b:g),a.notify("success",d.translate("successSave")))})}}]};this.database.createWindow(c,f)},save:function(b,a,d){var c=this.database.getFormData();if(c){var f=this.ssi,g=e.extend({},this.options.data,c);b="inUrl"==this.options.sendId?-1==this.database.currentCollection.baseUrl.indexOf("/:id")?
this.database.currentCollection.baseUrl+"/"+b:this.database.currentCollection.baseUrl.replace(":id",b):this.database.currentCollection.baseurl;d=e.extend({},{data:g,type:"PUT",url:b},d,this.options.ajaxOptions);f.ajaxCall(d,function(b,d,e){"function"===typeof a&&a(b,d,e,c)});return this}}})})(jQuery);
